...
server = st.sidebar.text_input("Servidor SQL", "sqlserver")
database = st.sidebar.text_input("Base de datos", "master")
username = st.sidebar.text_input("Usuario", "sa")
password = st.sidebar.text_input("Contraseña", "YourStrong!Passw0rd", type="password")
